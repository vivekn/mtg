...
//userid array store the required numbers to be reffered to ids to be displayed
   ...
   FBML;  
   ?>  
   <fb:request-form action="http://apps.facebook.com/mapthegraph/" method="POST" invite="true" type="Map the Graph" content="<?php echo htmlentities($content);?>">  
   <fb:multi-friend-selector max="6" actiontext="Here are some of your friends who haven't added Map the Graph to their profile. " showborder="true" rows="5" exclude_ids="<?php echo $friends;?>"></fb:request-form>  
