	 ...
	 google.maps.event.addListener(map,'click',function (event) {
		if (statusChangeEnabled) {													 
			deleteOverlays();
			 ...
			 html.innerHTML = '<textarea name="st_text" id="st_text"  ></textarea><br>\
Pick a Tag: \
<input type="radio" name="group" value="" checked></input> \ 
<img class="tag_img" src="../globe.jpg" width="32" height="32" title="Nothing in particular"></img> \
<input type="radio" name="group" value="home"></input> \
<img class="tag_img" src="../home48.png" width="32" height="32" title="home"></img> \
<input type="radio" name="group" value="restaurant"></input> \
<img class="tag_img" src="../dine.jpg" width="32" height="32" title="restaurant"></img> \
<input type="radio" name="group" value="workplace"></input> \
<img class="tag_img" src="../workplace.gif" width="32" height="32" title="workplace"></img>\
<input type="radio" name="group" value="school"></input>\
<img class="tag_img" src="../school-icon.png" width="32" height="32" title = "college/school"></img>\
<br>';
			 //TODO: Add drop down box with images and text
			 //TODO: update status update php script accordingly
