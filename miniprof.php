...
<LINK REL=StyleSheet HREF="design.css" TYPE="text/css" MEDIA=screen>
   ...
   <?php print_status($t); ?>
    ...
    <?php 
		...
		if ($GAME_ENABLED) {
				$sc = get_score($me);
				echo "<a style='float: left;'>Your Score: $sc </a><br><a style ='float: left;' href='#' onclick =\"$('#help').dialog({autoOpen:false,modal:true,height:350,width:400}).load('help.htm').dialog('open');\" >More info!</a>";
			}
    ?>
    <a href="inv3.php" target="_top" style="float: right;">Invite Friends</a>
    </div>
    <div id = "help" title = "KY mapTheGraph! Contest"/>
<HR>
